...
DoxyGen, Graphviz (http://www.research.att.com/sw/tools/graphviz/) and
Aladdin Ghostscript (http://www.cs.wisc.edu/~ghost/) are the basic
requirement to produce html documentation.
