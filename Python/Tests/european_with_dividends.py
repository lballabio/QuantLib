        ...
        for Rrate in rangeRrate:
          for strike in rangeStrike:
            for vol in rangeVol:
              ...
              dVol = vol/10000.0
              dR = Rrate/10000.0
              option = pricer(typ,under,strike,Qrate,Rrate,resTime,vol,div,dates) 
              opt_val = option.value()
              if opt_val>0.00001*under:
                optionPs = pricer(typ,under+dS,strike,Qrate,Rrate   ,resTime   ,vol,div,dates) 
                optionMs = pricer(typ,under-dS,strike,Qrate,Rrate   ,resTime   ,vol,div,dates) 
                optionPt = pricer(typ,under   ,strike,Qrate,Rrate   ,resTime+dT,vol,div,dates) 
                optionMt = pricer(typ,under   ,strike,Qrate,Rrate   ,resTime-dT,vol,div,dates) 
                optionPr = pricer(typ,under   ,strike,Qrate,Rrate+dR,resTime   ,vol,div,dates) 
                optionMr = pricer(typ,under   ,strike,Qrate,Rrate-dR,resTime   ,vol,div,dates) 
                optionPv = pricer(typ,under   ,strike,Qrate,Rrate   ,resTime   ,vol+dVol,div,dates) 
                optionMv = pricer(typ,under   ,strike,Qrate,Rrate   ,resTime   ,vol-dVol,div,dates) 
