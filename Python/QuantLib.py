...
class Date:
    ...
    def __isub__(*args, **kwargs):
        ...
        return val
    def __repr__(self):
        return "<C Date instance at %s>" % (self.this,)
class DatePtr(Date):
    def __init__(self,this):
        self.this = this
        self.thisown = 0
...
class FiniteDifferenceEuropean:
    ...
    def getGrid(*args, **kwargs):
        val = apply(QuantLibc.FiniteDifferenceEuropean_getGrid,args, kwargs)
        if val: val = ArrayPtr(val) ; val.thisown = 1
        return val
    def getPrices(*args, **kwargs):
        val = apply(QuantLibc.FiniteDifferenceEuropean_getPrices,args, kwargs)
        if val: val = ArrayPtr(val) ; val.thisown = 1
        return val
    def __repr__(self):
...
class DividendShoutOption:
    def __init__(self,*args,**kwargs):
        self.this = apply(QuantLibc.new_DividendShoutOption,args,kwargs)
        self.thisown = 1

    def __del__(self,QuantLibc=QuantLibc):
        if self.thisown == 1 :
            QuantLibc.delete_DividendShoutOption(self)
    def __repr__(self):
        return "<C DividendShoutOption instance at %s>" % (self.this,)
class DividendShoutOptionPtr(DividendShoutOption):
    def __init__(self,this):
        self.this = this
        self.thisown = 0
        self.__class__ = DividendShoutOption


DividendShoutOption.value = new.instancemethod(QuantLibc.DividendShoutOption_value, None, DividendShoutOption)
DividendShoutOption.delta = new.instancemethod(QuantLibc.DividendShoutOption_delta, None, DividendShoutOption)
DividendShoutOption.gamma = new.instancemethod(QuantLibc.DividendShoutOption_gamma, None, DividendShoutOption)
DividendShoutOption.theta = new.instancemethod(QuantLibc.DividendShoutOption_theta, None, DividendShoutOption)
DividendShoutOption.vega = new.instancemethod(QuantLibc.DividendShoutOption_vega, None, DividendShoutOption)
DividendShoutOption.rho = new.instancemethod(QuantLibc.DividendShoutOption_rho, None, DividendShoutOption)
DividendShoutOption.impliedVolatility = new.instancemethod(QuantLibc.DividendShoutOption_impliedVolatility, None, DividendShoutOption)
