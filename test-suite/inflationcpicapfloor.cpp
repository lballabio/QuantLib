...
namespace inflation_cpi_capfloor_test {
    ...
    struct CommonVars {
        ...
        CommonVars() : nominals(1, 1000000) {
            ...
            Real fixData[] = {206.1, 207.3, 208.0, 208.9, 209.7, 210.9,
            ...
            Period cfMat[] = {3 * Years,  5 * Years,  7 * Years, 10 * Years,
...
void InflationCPICapFloorTest::cpicapfloorpricesurface() {
    ...
    InterpolatedCPICapFloorTermPriceSurface<Bilinear> cpiSurf(
        nominal, common.baseZeroRate, common.observationLag, common.calendar, common.convention,
        common.dcZCIIS, common.hii, common.nominalUK, common.cStrikesUK, common.fStrikesUK,
    ...
    if (fabs(premium - expPremium) > 1e-12) {
        BOOST_ERROR("The requested premium, "
                    << premium << ", does not equal the expected premium, " << expPremium << ".");
    }
...
void InflationCPICapFloorTest::cpicapfloorpricer() {
    ...
    Rate strike(0.03);
    Real baseCPI =
        common.hii->fixing(fixCalendar.adjust(startDate - common.observationLag, fixConvention));
    CPI::InterpolationType observationInterpolation = CPI::AsIndex;
    CPICapFloor aCap(Option::Call, nominal,
                     startDate, // start date of contract (only)
                     baseCPI,
                     maturity, // this is pre-adjustment!
                     fixCalendar, fixConvention, payCalendar, payConvention, strike, common.hii,
