...
void MarketModelSmmCapletAlphaCalibrationTest::testFunction() {
    ...
    // create calibrator
    CapletCoterminalSwaptionCalibration2 calibrator(evolution,
                                                    corr,
                                                    swapVariances,
                                                    capletVols_,
                                                    cs,
    ...
    Integer steps = 100;
    Real toleranceForAlphaSolving = 1e-8;
...
test_suite* MarketModelSmmCapletAlphaCalibrationTest::suite() {
    ...
    suite->add(BOOST_TEST_CASE(&MarketModelSmmCapletAlphaCalibrationTest::testFunction));
