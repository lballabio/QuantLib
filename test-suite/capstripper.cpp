...
void setMarketVolatilityTermStructure(){
    ...
    smileSections[0] = boost::shared_ptr<InterpolatedSmileSection<> > 
        (new InterpolatedSmileSection<>(Date(39069), futureOptionStrikes, volatilities, dayCounter));
    ...
    smileSections[1] = boost::shared_ptr<InterpolatedSmileSection<> > 
        (new InterpolatedSmileSection<>(Date(39160), futureOptionStrikes, volatilities, dayCounter));
    ...
    smileSections[2] = boost::shared_ptr<InterpolatedSmileSection<> > 
        (new InterpolatedSmileSection<>(Date(39251),  futureOptionStrikes, volatilities, dayCounter));
    ...
    smileSections[3] = boost::shared_ptr<InterpolatedSmileSection<> > 
        (new InterpolatedSmileSection<>(Date(39342), futureOptionStrikes, volatilities, dayCounter));
