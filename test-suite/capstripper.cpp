...
void setMarketVolatilityTermStructure(){
    ...
    smileSections[0] = boost::shared_ptr<InterpolatedSmileSection<> >
        (new InterpolatedSmileSection<>(Date(computationDate + 15), futureOptionStrikes, volatilities, dayCounter));
    ...
    smileSections[1] = boost::shared_ptr<InterpolatedSmileSection<> >
        (new InterpolatedSmileSection<>(Date(computationDate + 115), futureOptionStrikes, volatilities, dayCounter));
    ...
    smileSections[2] = boost::shared_ptr<InterpolatedSmileSection<> >
        (new InterpolatedSmileSection<>(Date(computationDate + 195),  futureOptionStrikes, volatilities, dayCounter));
    ...
    smileSections[3] = boost::shared_ptr<InterpolatedSmileSection<> >
        (new InterpolatedSmileSection<>(Date(computationDate + 285), futureOptionStrikes, volatilities, dayCounter));
