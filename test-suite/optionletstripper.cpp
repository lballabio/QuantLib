...
struct CommonVars{
    ...
    void setRealTermStructure() {
        ...
        rates += -0.00292, -0.00292, -0.001441, -0.00117, -0.001204, -0.001212,
            ...
            0.005606, 0.006856, 0.00813, 0.008709, 0.009136, 0.009601, 0.009384;
        ...
        rates += 0.000649, 0.000649, 0.000684, 0.000717, 0.000745, 0.000872,
            ...
            0.004743, 0.00551, 0.006198, 0.006798, 0.007339, 0.007832, 0.008242,
            0.008614, 0.008935, 0.009205, 0.009443, 0.009651, 0.009818,
            0.009952, 0.010054, 0.010146, 0.010206, 0.010266, 0.010315,
            0.010365, 0.010416, 0.010468, 0.010519, 0.010571, 0.010757,
            0.010806, 0.010423, 0.010217;
    ...
    void setRealCapFloorTermVolSurface() {
        ...
        rawVols += 0.49, 0.39, 0.34, 0.31, 0.34, 0.37, 0.50, 0.75, 0.99, 1.21,
            1.64, 2.44, 4.29, 0.44, 0.36, 0.33, 0.31, 0.33, 0.35, 0.45, 0.65,
            0.83, 1.00, 1.32, 1.93, 3.30, 0.40, 0.35, 0.33, 0.31, 0.33, 0.34,
            0.41, 0.55, 0.69, 0.82, 1.08, 1.56, 2.68, 0.42, 0.39, 0.38, 0.37,
            0.38, 0.39, 0.43, 0.54, 0.64, 0.74, 0.94, 1.31, 2.18, 0.46, 0.43,
            0.42, 0.41, 0.42, 0.43, 0.47, 0.56, 0.66, 0.75, 0.93, 1.28, 2.07,
            0.49, 0.47, 0.46, 0.45, 0.46, 0.47, 0.51, 0.59, 0.68, 0.76, 0.93,
            1.25, 1.99, 0.51, 0.49, 0.49, 0.48, 0.49, 0.50, 0.54, 0.62, 0.70,
            0.78, 0.94, 1.24, 1.94, 0.52, 0.51, 0.51, 0.51, 0.52, 0.53, 0.56,
            0.63, 0.71, 0.79, 0.94, 1.23, 1.89, 0.53, 0.52, 0.52, 0.52, 0.53,
            0.54, 0.57, 0.65, 0.72, 0.79, 0.94, 1.21, 1.83, 0.55, 0.54, 0.54,
            0.54, 0.55, 0.56, 0.59, 0.66, 0.72, 0.79, 0.91, 1.15, 1.71, 0.56,
            0.56, 0.56, 0.56, 0.57, 0.58, 0.61, 0.67, 0.72, 0.78, 0.89, 1.09,
            1.59, 0.59, 0.58, 0.58, 0.59, 0.59, 0.60, 0.63, 0.68, 0.73, 0.78,
            0.86, 1.03, 1.45, 0.61, 0.61, 0.61, 0.61, 0.62, 0.62, 0.64, 0.69,
            0.73, 0.77, 0.85, 1.02, 1.44, 0.62, 0.62, 0.63, 0.63, 0.63, 0.64,
            0.65, 0.69, 0.72, 0.76, 0.82, 0.96, 1.32, 0.62, 0.63, 0.63, 0.63,
            0.63, 0.64, 0.65, 0.68, 0.71, 0.74, 0.80, 0.93, 1.25, 0.62, 0.62,
            0.62, 0.62, 0.63, 0.63, 0.64, 0.67, 0.69, 0.72, 0.78, 0.90, 1.20;

        termV = Matrix(optionTenors.size(), strikes.size(), rawVols) / 100;

        capFloorVolRealSurface = boost::shared_ptr< CapFloorTermVolSurface >(
            new CapFloorTermVolSurface(0, calendar, Following, optionTenors,
                                       strikes, termV, dayCounter));
    }
};
}
