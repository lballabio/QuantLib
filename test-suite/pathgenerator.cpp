...
namespace {
    ...
    void testSingle(const std::shared_ptr<StochasticProcess1D>& process,
    ...
    void testMultiple(const std::shared_ptr<StochasticProcess>& process,
...
void PathGeneratorTest::testPathGenerator() {
    ...
    testSingle(std::shared_ptr<StochasticProcess1D>(
...
void PathGeneratorTest::testMultiPathGenerator() {
    ...
    std::vector<std::shared_ptr<StochasticProcess1D> > processes(3);
    ...
    processes[2] = std::shared_ptr<StochasticProcess1D>(
                                 new BlackScholesMertonProcess(x0,q,r,sigma));
    process = std::shared_ptr<StochasticProcess>(
