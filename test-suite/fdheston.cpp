...
void FdHestonTest::testFdmHestonBarrier() {
    ...
    const Real tol = 0.01;
    const Real npvExpected   =  9.1781;
    const Real deltaExpected =  0.5245;
...
void FdHestonTest::testFdmHestonEuropeanWithDividends() {
    ...
    const Real npvExpected   =  6.7504;
    const Real deltaExpected = -0.3487;
    const Real gammaExpected =  0.0231;
