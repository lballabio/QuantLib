...
ALL : "QuantLibFunctions - Win32 Release" "QuantLib - Win32 Release" "$(OUTDIR)\testsuite.exe" "$(OUTDIR)\testsuite.bsc"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"QuantLib - Win32 ReleaseCLEAN" "QuantLibFunctions - Win32 ReleaseCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	...
	-@erase "$(INTDIR)\rngtraits.obj"
	-@erase "$(INTDIR)\rngtraits.sbr"
...
ALL : "QuantLibFunctions - Win32 Debug" "QuantLib - Win32 Debug" "$(OUTDIR)\testsuite.exe" "$(OUTDIR)\testsuite.bsc"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"QuantLib - Win32 DebugCLEAN" "QuantLibFunctions - Win32 DebugCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\americanoption.obj"
...
ALL : "QuantLibFunctions - Win32 Release MTDLL" "QuantLib - Win32 Release MTDLL" "$(OUTDIR)\testsuite.exe" "$(OUTDIR)\testsuite.bsc"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"QuantLib - Win32 Release MTDLLCLEAN" "QuantLibFunctions - Win32 Release MTDLLCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\americanoption.obj"
...
ALL : "QuantLibFunctions - Win32 Debug MTDLL" "QuantLib - Win32 Debug MTDLL" "$(OUTDIR)\testsuite.exe" "$(OUTDIR)\testsuite.bsc"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"QuantLib - Win32 Debug MTDLLCLEAN" "QuantLibFunctions - Win32 Debug MTDLLCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\americanoption.obj"
...
ALL : "QuantLibFunctions - Win32 Release SingleThread" "QuantLib - Win32 Release SingleThread" "$(OUTDIR)\testsuite.exe" "$(OUTDIR)\testsuite.bsc"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"QuantLib - Win32 Release SingleThreadCLEAN" "QuantLibFunctions - Win32 Release SingleThreadCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\americanoption.obj"
...
ALL : "QuantLibFunctions - Win32 Debug SingleThread" "QuantLib - Win32 Debug SingleThread" "$(OUTDIR)\testsuite.exe" "$(OUTDIR)\testsuite.bsc"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"QuantLib - Win32 Debug SingleThreadCLEAN" "QuantLibFunctions - Win32 Debug SingleThreadCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\americanoption.obj"
...
"$(INTDIR)\rngtraits.obj"	"$(INTDIR)\rngtraits.sbr" : $(SOURCE) "$(INTDIR)"
...
"QuantLibFunctions - Win32 Release" : 
   cd "\Projects\QuantLib\Trunk\QuantLib\FUNCTIONS\QL\FUNCTIONS"
