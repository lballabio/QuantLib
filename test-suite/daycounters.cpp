...
void DayCounterTest::runTest() {
    ...
    SingleCase testCases[] = {
        // first example
        { ActualActual::ISDA, 
          Date(1,November,2003), Date(1,May,2004), Date(), Date(),
          0.497724380567 },
        { ActualActual::ISMA,
        ...
        { ActualActual::ISDA, 
          Date(1,February,1999), Date(1,July,1999), Date(), Date(),
          0.410958904110 },
        { ActualActual::ISMA,
        ...
        { ActualActual::ISDA, 
          Date(1,July,1999), Date(1,July,2000), Date(), Date(),
          1.001377348600 },
        { ActualActual::ISMA,
        ...
        { ActualActual::ISDA, 
          Date(15,August,2002), Date(15,July,2003), Date(), Date(),
          0.915068493151 },
        { ActualActual::ISMA,
        ...
        { ActualActual::ISDA, 
          Date(15,July,2003), Date(15,January,2004), Date(), Date(),
          0.504004790778 },
        { ActualActual::ISMA,
        ...
        { ActualActual::ISDA, 
          Date(30,July,1999), Date(30,January,2000), Date(), Date(),
          0.503892506924 },
        { ActualActual::ISMA,
        ...
        { ActualActual::ISDA, 
          Date(30,January,2000), Date(30,June,2000), Date(), Date(),
          0.415300546448 },
        { ActualActual::ISMA,
