...
CppUnit VC++ projects use the '(Debug) Multithread DLL' setting, which works
fine with the QuantLib 'Release/Debug DLL' configurations.
Switch CppUnit to '(Debug) Multithread' in order to make it work with QuantLib
