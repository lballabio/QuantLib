...
BOOST_AUTO_TEST_SUITE(BlackVarianceSurfaceFromSmileSectionsSuite)
...
BOOST_AUTO_TEST_CASE(testExactRepricing) {
    ...
    BlackVarianceSurfaceFromSmileSections surface(today, dates, sections, dc);
...
BOOST_AUTO_TEST_CASE(testObserver) {
    ...
    auto surface = ext::make_shared<BlackVarianceSurfaceFromSmileSections>(
