...
namespace QuantLib
{
    namespace Pricers
    {
        PerformanceOption::PerformanceOption(Option::Type type,
...
/*
        Handle<SingleAssetOption> PerformanceOption::clone() const {
            return Handle<SingleAssetOption>(new PerformanceOption(*this));
        }
*/
