...
namespace QuantLib {
      ...
      public:
        ...
        */
        ...
        Date endOfMonth(const Date& d,
                        BusinessDayConvention conv = Preceding) const;
    ...
    */
    ...
    inline Date Calendar::endOfMonth(const Date& d, BusinessDayConvention conv) const {
        return adjust(Date::endOfMonth(d), conv);
    }
