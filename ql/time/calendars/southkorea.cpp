...
namespace QuantLib {
    ...
    bool SouthKorea::SettlementImpl::isBusinessDay(const Date& date) const {
        ...
        if (isWeekend(w)
            ...
            (d == 8 && m == May && y == 2022) || (d == 26 && m == May && y == 2023) ||
            (d == 15 && m == May && y == 2024) || (d == 5 && m == May && y == 2025) ||
            (d == 24 && m == May && y == 2026) || (d == 13 && m == May && y == 2027) ||
            (d == 2 && m == May && y == 2028) || (d == 20 && m == May && y == 2029) ||
