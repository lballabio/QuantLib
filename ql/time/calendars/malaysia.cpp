    ...
    namespace {
        ...
        bool isTabulatedHoliday(const Date& date) {
            static const std::vector<Date> holidays = {
                ...
                Date(10, July, 2016),      // Hari Raya Aidilfitri
                ...
                Date(9, September, 2017),  // Agong's Birthday
                ...
                Date(9, September, 2018),  // Agong's Birthday
                ...
                Date(8, February, 2020),  // Thaipusam
                ...
                Date(1, August, 2020),    // Hari Raya Haji (in lieu)
                ...
                Date(30, April, 2021),    // Nuzul Al-Quran
                ...
                Date(21, July, 2021),     // Hari Raya Haji (in lieu)
                ...
                Date(30, June, 2023),      // Hari Raya Haji (in lieu)
                ...
                Date(18, June, 2024),      // Hari Raya Haji (in lieu)
                ...
                Date(8, June, 2025),       // Hari Raya Haji (in lieu)
                ...
                Date(3, February, 2026),  // Thaipusam (in lieu)
                ...
                Date(28, May, 2026),      // Hari Raya Haji (in lieu)
                ...
                Date(25, February, 2027), // Nuzul Al-Quran
                Date(9, March, 2027),     // Hari Raya Aidilfitri
                Date(10, March, 2027),    // Hari Raya Aidilfitri (in lieu)
                Date(16, May, 2027),      // Hari Raya Haji (in lieu)
                Date(20, May, 2027),      // Wesak Day
                Date(6, June, 2027),      // Awal Muharram
                Date(7, June, 2027),      // Agong's Birthday
                Date(15, August, 2027),   // Maulidur Rasul
                Date(29, October, 2027),  // Deepavali
            };
