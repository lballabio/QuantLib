...
# Primary target:
# static library
CalibrationHelpers$(_mt)$(_D).lib:: $(OBJS)
    if exist CalibrationHelpers$(_mt)$(_D).lib     del CalibrationHelpers$(_mt)$(_D).lib
    $(TLIB) $(TLIB_OPTS) "CalibrationHelpers$(_mt)$(_D).lib" /a $(OBJS)
