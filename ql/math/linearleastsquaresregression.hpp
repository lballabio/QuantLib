    ...
    namespace details {
        ...
        class LinearFcts {
          public:
            ...
            const std::vector< boost::function<Real(ArgumentType)> > & fcts() {
                return v;
            }

          private:
            std::vector< boost::function<Real(ArgumentType)> > v;
        };
    ...
    class LinearLeastSquaresRegression : public GeneralLinearLeastSquares {
      public:
        LinearLeastSquaresRegression(
            ...
            const std::vector<boost::function<Real(ArgumentType)> > & v)
        : GeneralLinearLeastSquares(x, y, v) {
        }
    };
}
