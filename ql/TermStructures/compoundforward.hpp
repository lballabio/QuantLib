...
namespace QuantLib {
	...
	//! \name static methods
	//@{
	static std::vector<Date> calibratedDateList(
	    const std::vector<Date>&,const Date&,const Calendar&,
	    const RollingConvention,int);
    protected:
	// methods
	...
	mutable boost::shared_ptr<FwdInterpolation> fwdinterp_;
