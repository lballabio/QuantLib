...
# Primary target:
# static library
FiniteDifferences$(_mt)$(_D).lib:: $(OBJS)
    if exist FiniteDifferences$(_mt)$(_D).lib     del FiniteDifferences$(_mt)$(_D).lib
    $(TLIB) $(TLIB_OPTS) "FiniteDifferences$(_mt)$(_D).lib" /a $(OBJS)
