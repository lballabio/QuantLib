...
namespace QuantLib {
    ...
    */
    BTCCurrency::BTCCurrency() {
        QL_STATIC ext::shared_ptr<Data> btcData(
    ...
    */
    ETHCurrency::ETHCurrency() {
        QL_STATIC ext::shared_ptr<Data> ethData(
    ...
    */
    ETCCurrency::ETCCurrency() {
        QL_STATIC ext::shared_ptr<Data> etcData(
    ...
    */
    BCHCurrency::BCHCurrency() {
        QL_STATIC ext::shared_ptr<Data> bchData(
    ...
    */
    XRPCurrency::XRPCurrency() {
        QL_STATIC ext::shared_ptr<Data> xrpData(
    ...
    */
    LTCCurrency::LTCCurrency() {
            QL_STATIC ext::shared_ptr<Data> ltcData(
    ...
    */
    DASHCurrency::DASHCurrency() {
        QL_STATIC ext::shared_ptr<Data> dashData(
    ...
    */
    ZECCurrency::ZECCurrency() {
        QL_STATIC ext::shared_ptr<Data> zecData(
