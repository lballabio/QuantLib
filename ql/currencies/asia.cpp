...
namespace QuantLib {
    ...
    */
    KZTCurrency::KZTCurrency() {
        static std::shared_ptr<Data> kztData(
    ...
    */
    ...
    QARCurrency::QARCurrency() {
        static std::shared_ptr<Data> qarData(
    ...
    BHDCurrency::BHDCurrency() {
        static std::shared_ptr<Data> bhdData(
    ...
    OMRCurrency::OMRCurrency() {
        static std::shared_ptr<Data> omrData(
    ...
    JODCurrency::JODCurrency() {
        static std::shared_ptr<Data> jodData(
    ...
    AEDCurrency::AEDCurrency() {
        static std::shared_ptr<Data> aedData(new Data("United Arab Emirates dirham", "AED", 784,
    ...
    PHPCurrency::PHPCurrency() {
        static std::shared_ptr<Data> phpData(
    ...
    CNHCurrency::CNHCurrency() {
        static std::shared_ptr<Data> cnhData(new Data("Chinese yuan (Hong Kong)", "CNH", 156,
    ...
    LKRCurrency::LKRCurrency() {
        static std::shared_ptr<Data> lkrData(
