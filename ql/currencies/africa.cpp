...
namespace QuantLib {
    ...
    AOACurrency::AOACurrency() {
        static std::shared_ptr<Data> aoaData(
    ...
    BWPCurrency::BWPCurrency() {
        static std::shared_ptr<Data> bwpData(
    ...
    EGPCurrency::EGPCurrency() {
        static std::shared_ptr<Data> egpData(
    ...
    ETBCurrency::ETBCurrency() {
        static std::shared_ptr<Data> etbData(
    ...
    GHSCurrency::GHSCurrency() {
        static std::shared_ptr<Data> ghsData(
    ...
    KESCurrency::KESCurrency() {
        static std::shared_ptr<Data> kesData(
    ...
    MADCurrency::MADCurrency() {
        static std::shared_ptr<Data> madData(
    ...
    MURCurrency::MURCurrency() {
        static std::shared_ptr<Data> murData(
    ...
    NGNCurrency::NGNCurrency() {
        static std::shared_ptr<Data> ngnData(
    ...
    TNDCurrency::TNDCurrency() {
        static std::shared_ptr<Data> tndData(
    ...
    UGXCurrency::UGXCurrency() {
        static std::shared_ptr<Data> ugxData(
    ...
    XOFCurrency::XOFCurrency() {
        static std::shared_ptr<Data> xofData(new Data("West African CFA franc", "XOF", 952, "XOF",
                                                      "", 100, Rounding(), "1$.2f %3%"));
        data_ = xofData;
    }
    ...
    ZMWCurrency::ZMWCurrency() {
        static std::shared_ptr<Data> zmwData(
