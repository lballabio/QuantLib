...
/*! \file crosscurrencyswap.hpp
    \brief Generic cross-currency swap
*/

#ifndef quantlib_cross_currency_swap_base_hpp
#define quantlib_cross_currency_swap_base_hpp
...
//! Generic cross-currency swap
/*! This base class adds leg currencies and in-currency leg results to the
...
class CrossCurrencySwap : public Swap {
  public:
    ...
    */
    CrossCurrencySwap(const Leg& firstLeg,
    ...
    */
    CrossCurrencySwap(const std::vector<Leg>& legs,
  ...
  protected:
    ...
    */
    explicit CrossCurrencySwap(Size legs);
    //@}
    //! \name Instrument interface
    //@{
    ...
    static void addNotionalExchangesToLeg(Leg& leg,
...
class CrossCurrencySwap::engine
    : public GenericEngine<CrossCurrencySwap::arguments,
