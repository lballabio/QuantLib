...
/*! \file digitalpathpricer.hpp
    \brief path pricer for digital options
*/

#ifndef quantlib_montecarlo_digital_path_pricer_h
#define quantlib_montecarlo_digital_path_pricer_h
...
namespace QuantLib {
    ...
    //! %path pricer for digital options
