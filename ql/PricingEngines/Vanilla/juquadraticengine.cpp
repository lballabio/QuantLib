...
namespace QuantLib {
    ...
    */
    ...
    namespace {
        ...
        //  NOTE - WARNING
        // This is exactly the same method as in BAW. It works, but has 
        // not been modified to see whether the method of Ju is faster.
        // Ju does not say how he solves the equation for the critical 
