...
namespace QuantLib {
	...
	public:
	    std::string name() const { return "Canadian Dollar"; };
	    std::string mnemonic() const { return "CAD"; };
	    ...
	    Currency nextCurrency() const { return CADCurrency(); }
	    Currency lastCurrency() const { return CADCurrency(); }
	};
    public:
	CADCurrency();
    };
