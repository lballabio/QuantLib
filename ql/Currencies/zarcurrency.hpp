...
namespace QuantLib {
	...
	public:
	    std::string name() const { return "S.A Rand"; };
	    std::string mnemonic() const { return "ZAR"; };
	    std::string numeric() const { return "N/A"; };
	    std::string symbol() const { return "R"; };
	    bool isRounding() const { return false; }
	    Rounding prefRounding() const { return Rounding(); }
	    Currency nextCurrency() const { return ZARCurrency(); }
	    Currency lastCurrency() const { return ZARCurrency(); }
	};
    public:
	ZARCurrency();
    };
