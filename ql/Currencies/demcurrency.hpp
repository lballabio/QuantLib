...
namespace QuantLib {
	...
	public:
	    std::string name() const { return "Deutch Marks"; };
	    std::string mnemonic() const { return "DEM"; };
	    ...
	    Currency nextCurrency() const { return DEMCurrency(); }
	    Currency lastCurrency() const { return DEMCurrency(); }
	};
    public:
	DEMCurrency();
    };
