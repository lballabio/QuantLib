...
/*! \file fdmhestonquantohelper.hpp
    \brief quanto helper to store market data needed for the quanto adjustment.
*/

#ifndef quantlib_fdm_heston_quanto_helper_hpp
#define quantlib_fdm_heston_quanto_helper_hpp
...
namespace QuantLib {
    ...
    class FdmHestonQuantoHelper : public Observable {
    public:
        FdmHestonQuantoHelper(const boost::shared_ptr<YieldTermStructure> & rTS,
