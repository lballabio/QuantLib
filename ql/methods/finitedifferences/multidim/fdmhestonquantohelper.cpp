...
/*! \file fdmhestonquantohelper.cpp
...
namespace QuantLib {
    ...
    FdmHestonQuantoHelper::FdmHestonQuantoHelper(
    ...
    Rate FdmHestonQuantoHelper::quantoAdjustment(Volatility equityVol, 
    ...
    Disposable<Array> FdmHestonQuantoHelper::quantoAdjustment(
