...
namespace QuantLib {
    ...
    FdmCellAveragingInnerValue::FdmCellAveragingInnerValue(std::shared_ptr<Payoff> payoff,
    ...
    FdmLogBasketInnerValue::FdmLogBasketInnerValue(std::shared_ptr<BasketPayoff> payoff,
                                                   std::shared_ptr<FdmMesher> mesher)
