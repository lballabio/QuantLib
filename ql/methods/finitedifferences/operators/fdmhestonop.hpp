...
namespace QuantLib {
    ...
    class FdmHestonEquityPart {
      public:
        FdmHestonEquityPart(const std::shared_ptr<FdmMesher>& mesher,
    ...
    class FdmHestonVariancePart {
      public:
        FdmHestonVariancePart(const std::shared_ptr<FdmMesher>& mesher,
                              std::shared_ptr<YieldTermStructure> rTS,
                              Real mixedSigma,
                              Real kappa,
                              Real theta);
    ...
    class FdmHestonOp : public FdmLinearOpComposite {
      public:
        FdmHestonOp(const std::shared_ptr<FdmMesher>& mesher,
