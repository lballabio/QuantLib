...
namespace QuantLib {
    ...
    MarketModelCoinitialSwapsOneStep::MarketModelCoinitialSwapsOneStep(
    ...
    EvolutionDescription MarketModelCoinitialSwapsOneStep::suggestedEvolution() const
    {
    ...
    bool MarketModelCoinitialSwapsOneStep::nextTimeStep(
