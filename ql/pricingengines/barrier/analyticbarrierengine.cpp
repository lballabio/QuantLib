...
namespace QuantLib {
    ...
    Real AnalyticBarrierEngine::C(Real eta, Real phi) const {
        ...
        return phi*(underlying() * dividendDiscount() * (N1 == 0.0 ? static_cast<Real>(0.0) : (powHS1 * N1))
                      - strike() * riskFreeDiscount() * (N2 == 0.0 ? static_cast<Real>(0.0) : (powHS0 * N2)));
    }
    ...
    Real AnalyticBarrierEngine::E(Real eta) const {
        if (rebate() > 0) {
            ...
            return rebate() * riskFreeDiscount() * (N1 - (N2 == 0.0 ? static_cast<Real>(0.0) : (powHS0 * N2)));
        } else {
            return 0.0;
        }
    }
    ...
    Real AnalyticBarrierEngine::F(Real eta) const {
        if (rebate() > 0) {
            ...
            return rebate() * ((N1 == 0.0 ? static_cast<Real>(0.0) : (powHSplus * N1)) + (N2 == 0.0 ? static_cast<Real>(0.0) : (powHSminus * N2)));
        } else {
            return 0.0;
        }
    }
