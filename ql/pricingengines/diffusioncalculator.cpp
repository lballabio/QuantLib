...
namespace QuantLib {
    ...
    : strike_(p->strike()), forward_(forward), stdDev_(stdDev),
      discount_(discount), variance_(stdDev*stdDev) {
        // Note: derived classes should call initialize(p) in their constructors
    }
    ...
    : strike_(strike), forward_(forward), stdDev_(stdDev),
      discount_(discount), variance_(stdDev*stdDev) {
        // Note: derived classes should call initialize with appropriate payoff in their constructors
    }
