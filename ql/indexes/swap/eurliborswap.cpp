...
namespace QuantLib {
    ...
    : SwapIndex("EurLiborSwapIsdaFixA", // familyName
                ...
                tenor > 1*Years ?
                    std::shared_ptr<IborIndex>(new EURLibor(6*Months, h)) :
                    std::shared_ptr<IborIndex>(new EURLibor(3*Months, h))) {}
    ...
    : SwapIndex("EurLiborSwapIsdaFixA", // familyName
                ...
                Thirty360(Thirty360::BondBasis), // fixedLegDaycounter
                tenor > 1*Years ?
                    std::shared_ptr<IborIndex>(new EURLibor(6*Months, forwarding)) :
                    std::shared_ptr<IborIndex>(new EURLibor(3*Months, forwarding)),
                discounting) {}
