...
namespace QuantLib {
    ...
    int Thirty360::US_Impl::dayCount(const Date& d1, const Date& d2) const {
    ...
    int Thirty360::EU_Impl::dayCount(const Date& d1, const Date& d2) const {
        int dd1 = d1.dayOfMonth(), dd2 = d2.dayOfMonth();
        int mm1 = d1.month(), mm2 = d2.month();
        int yy1 = d1.year(), yy2 = d2.year();
    ...
    int Thirty360::IT_Impl::dayCount(const Date& d1, const Date& d2) const {
        int dd1 = d1.dayOfMonth(), dd2 = d2.dayOfMonth();
        int mm1 = d1.month(), mm2 = d2.month();
        int yy1 = d1.year(), yy2 = d2.year();
