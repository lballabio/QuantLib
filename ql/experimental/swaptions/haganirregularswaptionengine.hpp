...
namespace QuantLib {
    ...
    */
    ...
    public:
      ...
      class Basket {
        public:
          Basket(std::shared_ptr<IrregularSwap> swap,
        ...
        Real HKPrice(Basket& basket,std::shared_ptr<Exercise>& exercise)  const;
        Real LGMPrice(Basket& basket,std::shared_ptr<Exercise>& exercise) const;
