...
namespace QuantLib {
    ...
    */
    class CmsSpreadCoupon : public FloatingRateCoupon {
      public:
        CmsSpreadCoupon(const Date& paymentDate,
                  ...
                  const Date& endDate,
                  Natural fixingDays,
                  const std::shared_ptr<SwapSpreadIndex>& index,
                  Real gearing = 1.0,
                  Spread spread = 0.0,
        ...
        //! \name Inspectors
        //@{
        const std::shared_ptr<SwapSpreadIndex>& swapSpreadIndex() const {
            return index_;
        }
        //@}
        //! \name Visitability
    ...
    class CmsSpreadLeg {
      public:
        CmsSpreadLeg(Schedule schedule, std::shared_ptr<SwapSpreadIndex> swapSpreadIndex);
      ...
      private:
        Schedule schedule_;
        std::shared_ptr<SwapSpreadIndex> swapSpreadIndex_;
