...
namespace QuantLib {
    ...
    */
    ...
    class MCAmericanPathEngine
      ...
      public:
        MCAmericanPathEngine(const std::shared_ptr<StochasticProcessArray>&,
                               Size timeSteps,
      ...
      protected:
        std::shared_ptr<LongstaffSchwartzMultiPathPricer>
                                                      lsmPathPricer() const;
    };
    ...
    class MakeMCAmericanPathEngine {
      public:
        explicit MakeMCAmericanPathEngine(std::shared_ptr<StochasticProcessArray>);
        // named parameters
    ...
    template <class RNG>
    inline std::shared_ptr<LongstaffSchwartzMultiPathPricer>
    MCAmericanPathEngine<RNG>::lsmPathPricer() const {
        ...
        return std::make_shared<LongstaffSchwartzMultiPathPricer> (
