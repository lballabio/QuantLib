...
namespace QuantLib {
    ...
    class CommodityCurve : public TermStructure {
      ...
      public:
        ...
        Real price(
               const Date& d,
               const std::shared_ptr<ExchangeContracts>& exchangeContracts,
        ...
        const std::shared_ptr<CommodityCurve>& basisOfCurve() const;
      ...
      protected:
        ...
        std::shared_ptr<CommodityCurve> basisOfCurve_;
    ...
    inline const std::shared_ptr<CommodityCurve>&
