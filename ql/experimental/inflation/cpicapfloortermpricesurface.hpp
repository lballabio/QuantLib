...
namespace QuantLib {
    ...
    //! Provides cpi cap/floor prices by interpolation and put/call parity (not cap/floor/swap*
    //! parity).
    /*!
    ...
    */
    ...
    inline Real CPICapFloorTermPriceSurface::nominal() const { return nominal_; }
