...
namespace QuantLib {
    ...
    class MCDoubleBarrierEngine : public DoubleBarrierOption::engine,
      ...
      public:
        ...
        typedef typename McSimulation<SingleVariate,RNG,S>::path_pricer_type
            path_pricer_type;
        // constructor
        MCDoubleBarrierEngine(std::shared_ptr<GeneralizedBlackScholesProcess> process,
                              Size timeSteps,
    ...
    class MakeMCDoubleBarrierEngine {
      public:
        explicit MakeMCDoubleBarrierEngine(std::shared_ptr<GeneralizedBlackScholesProcess>);
        // named parameters
    ...
    template <class RNG, class S>
    inline
    std::shared_ptr<typename MCDoubleBarrierEngine<RNG,S>::path_pricer_type>
    ...
    template <class RNG, class S>
    inline
    MakeMCDoubleBarrierEngine<RNG,S>::operator std::shared_ptr<PricingEngine>()
                                                                      const {
