...
namespace QuantLib {
    ...
    ExtendedLeisenReimer::ExtendedLeisenReimer(const std::shared_ptr<StochasticProcess1D>& process,
                                               Time end,
                                               Size steps,
                                               Real strike)
    ...
    ExtendedJoshi4::ExtendedJoshi4(const std::shared_ptr<StochasticProcess1D>& process,
                                   Time end,
                                   Size steps,
                                   Real strike)
