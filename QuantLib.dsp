...
# ADD LIB32 /nologo /out:".\lib\QuantLib-vc6-mt-s-0_9_0.lib"
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo
# ADD LIB32 /nologo /out:".\lib\QuantLib-vc6-mt-sgd-0_9_0.lib"
# Begin Special Build Tool
SOURCE="$(InputPath)"
PreLink_Desc=Make build directory
PreLink_Cmds=if not exist lib mkdir lib
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo
# ADD LIB32 /nologo /out:".\lib\QuantLib-vc6-mt-0_9_0.lib"
# Begin Special Build Tool
SOURCE="$(InputPath)"
PreLink_Desc=Make build directory
PreLink_Cmds=if not exist lib mkdir lib
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo
# ADD LIB32 /nologo /out:".\lib\QuantLib-vc6-mt-gd-0_9_0.lib"
# Begin Special Build Tool
SOURCE="$(InputPath)"
PreLink_Desc=Make build directory
PreLink_Cmds=if not exist lib mkdir lib
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo
# ADD LIB32 /nologo /out:".\lib\QuantLib-vc6-s-0_9_0.lib"
# Begin Special Build Tool
SOURCE="$(InputPath)"
PreLink_Desc=Make build directory
PreLink_Cmds=if not exist lib mkdir lib
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo
# ADD LIB32 /nologo /out:".\lib\QuantLib-vc6-sgd-0_9_0.lib"
# Begin Special Build Tool
SOURCE="$(InputPath)"
PreLink_Desc=Make build directory
PreLink_Cmds=if not exist lib mkdir lib
