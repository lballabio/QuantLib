...
# Primary target:
DiscreteHedging$(_D).exe: $(OBJDIR) DiscreteHedging.cpp
    bcc32 $(CC_OPTS) -L$(QL_LIB_DIR) -L$(BCC_LIBS) -o"$(OBJDIR)\DiscreteHedging$(_D).obj" -eDiscreteHedging$(_D).exe DiscreteHedging.cpp QuantLib$(_D).lib
