...
def get_kpi_index() -> ql.ZeroInflationIndex:
    kpi_index = ql.ZeroInflationIndex("KPI", ql.EURegion(), False, ql.Monthly, ql.Period(1, ql.Days), ql.SEKCurrency())
    ...
    kpi_schedule = ql.Schedule(from_date, to_date, ql.Period(ql.Monthly))
