...
!MESSAGE No configuration specified. Defaulting to BermudanSwaption - Win32 Debug MTDLL.
!ENDIF 

!IF "$(CFG)" != "BermudanSwaption - Win32 Release" && "$(CFG)" != "BermudanSwaption - Win32 Debug" && "$(CFG)" != "BermudanSwaption - Win32 Release MTDLL" && "$(CFG)" != "BermudanSwaption - Win32 Debug MTDLL"
