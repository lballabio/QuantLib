...
# Primary target:
AmericanOption$(_D).exe: $(OBJDIR) AmericanOption.cpp
    bcc32 $(CC_OPTS) -L$(QL_LIB_DIR) -L$(BCC_LIBS) -o"$(OBJDIR)\AmericanOption$(_D).obj" -eAmericanOption$(_D).exe AmericanOption.cpp QuantLib$(_D).lib
