...
ALL : "..\..\..\lib\QuantLibFunctions-vc6-mt-s-0_3_9.lib"

!ELSE 

ALL : "QuantLib - Win32 Release" "..\..\..\lib\QuantLibFunctions-vc6-mt-s-0_3_9.lib"
...
!ENDIF 
	...
	-@erase "..\..\..\lib\QuantLibFunctions-vc6-mt-s-0_3_9.lib"
...
LIB32=link.exe -lib
LIB32_FLAGS=/nologo /out:"..\..\..\lib\QuantLibFunctions-vc6-mt-s-0_3_9.lib" 
LIB32_OBJS= \
...
"..\..\..\lib\QuantLibFunctions-vc6-mt-s-0_3_9.lib" : "$(OUTDIR)" $(DEF_FILE) $(LIB32_OBJS)
    $(LIB32) @<<
...
ALL : "..\..\..\lib\QuantLibFunctions-vc6-mt-sgd-0_3_9.lib"

!ELSE 

ALL : "QuantLib - Win32 Debug" "..\..\..\lib\QuantLibFunctions-vc6-mt-sgd-0_3_9.lib"
...
!ENDIF 
	...
	-@erase "$(INTDIR)\vols.obj"
	-@erase "..\..\..\lib\QuantLibFunctions-vc6-mt-sgd-0_3_9.lib"
...
LIB32=link.exe -lib
LIB32_FLAGS=/nologo /out:"..\..\..\lib\QuantLibFunctions-vc6-mt-sgd-0_3_9.lib" 
LIB32_OBJS= \
	"$(INTDIR)\calendars.obj" \
	"$(INTDIR)\daycounters.obj" \
	"$(INTDIR)\mathf.obj" \
...
"..\..\..\lib\QuantLibFunctions-vc6-mt-sgd-0_3_9.lib" : "$(OUTDIR)" $(DEF_FILE) $(LIB32_OBJS)
    $(LIB32) @<<
  $(LIB32_FLAGS) $(DEF_FLAGS) $(LIB32_OBJS)
<<
...
ALL : "..\..\..\lib\QuantLibFunctions-vc6-mt-0_3_9.lib"

!ELSE 

ALL : "QuantLib - Win32 Release MTDLL" "..\..\..\lib\QuantLibFunctions-vc6-mt-0_3_9.lib"
...
!ENDIF 
	...
	-@erase "$(INTDIR)\vc60.idb"
	-@erase "$(INTDIR)\vols.obj"
	-@erase "..\..\..\lib\QuantLibFunctions-vc6-mt-0_3_9.lib"
...
LIB32=link.exe -lib
LIB32_FLAGS=/nologo /out:"..\..\..\lib\QuantLibFunctions-vc6-mt-0_3_9.lib" 
LIB32_OBJS= \
	"$(INTDIR)\calendars.obj" \
	"$(INTDIR)\daycounters.obj" \
	"$(INTDIR)\mathf.obj" \
...
"..\..\..\lib\QuantLibFunctions-vc6-mt-0_3_9.lib" : "$(OUTDIR)" $(DEF_FILE) $(LIB32_OBJS)
    $(LIB32) @<<
  $(LIB32_FLAGS) $(DEF_FLAGS) $(LIB32_OBJS)
<<
...
ALL : "..\..\..\lib\QuantLibFunctions-vc6-mt-gd-0_3_9.lib"

!ELSE 

ALL : "QuantLib - Win32 Debug MTDLL" "..\..\..\lib\QuantLibFunctions-vc6-mt-gd-0_3_9.lib"
...
!ENDIF 
	...
	-@erase "$(INTDIR)\vc60.pdb"
	-@erase "$(INTDIR)\vols.obj"
	-@erase "..\..\..\lib\QuantLibFunctions-vc6-mt-gd-0_3_9.lib"
...
LIB32=link.exe -lib
LIB32_FLAGS=/nologo /out:"..\..\..\lib\QuantLibFunctions-vc6-mt-gd-0_3_9.lib" 
LIB32_OBJS= \
	"$(INTDIR)\calendars.obj" \
	"$(INTDIR)\daycounters.obj" \
	"$(INTDIR)\mathf.obj" \
...
"..\..\..\lib\QuantLibFunctions-vc6-mt-gd-0_3_9.lib" : "$(OUTDIR)" $(DEF_FILE) $(LIB32_OBJS)
    $(LIB32) @<<
  $(LIB32_FLAGS) $(DEF_FLAGS) $(LIB32_OBJS)
<<
...
ALL : "..\..\..\lib\QuantLibFunctions-vc6-s-0_3_9.lib"

!ELSE 

ALL : "QuantLib - Win32 Release SingleThread" "..\..\..\lib\QuantLibFunctions-vc6-s-0_3_9.lib"
...
!ENDIF 
	...
	-@erase "$(INTDIR)\vc60.idb"
	-@erase "$(INTDIR)\vols.obj"
	-@erase "..\..\..\lib\QuantLibFunctions-vc6-s-0_3_9.lib"
...
LIB32=link.exe -lib
LIB32_FLAGS=/nologo /out:"..\..\..\lib\QuantLibFunctions-vc6-s-0_3_9.lib" 
LIB32_OBJS= \
	"$(INTDIR)\calendars.obj" \
	"$(INTDIR)\daycounters.obj" \
	"$(INTDIR)\mathf.obj" \
...
"..\..\..\lib\QuantLibFunctions-vc6-s-0_3_9.lib" : "$(OUTDIR)" $(DEF_FILE) $(LIB32_OBJS)
    $(LIB32) @<<
  $(LIB32_FLAGS) $(DEF_FLAGS) $(LIB32_OBJS)
<<
...
ALL : "..\..\..\lib\QuantLibFunctions-vc6-sgd-0_3_9.lib"

!ELSE 

ALL : "QuantLib - Win32 Debug SingleThread" "..\..\..\lib\QuantLibFunctions-vc6-sgd-0_3_9.lib"
...
!ENDIF 
	...
	-@erase "$(INTDIR)\vc60.pdb"
	-@erase "$(INTDIR)\vols.obj"
	-@erase "..\..\..\lib\QuantLibFunctions-vc6-sgd-0_3_9.lib"
...
LIB32=link.exe -lib
LIB32_FLAGS=/nologo /out:"..\..\..\lib\QuantLibFunctions-vc6-sgd-0_3_9.lib" 
LIB32_OBJS= \
	"$(INTDIR)\calendars.obj" \
	"$(INTDIR)\daycounters.obj" \
	"$(INTDIR)\mathf.obj" \
...
"..\..\..\lib\QuantLibFunctions-vc6-sgd-0_3_9.lib" : "$(OUTDIR)" $(DEF_FILE) $(LIB32_OBJS)
    $(LIB32) @<<
  $(LIB32_FLAGS) $(DEF_FLAGS) $(LIB32_OBJS)
<<
